...
Възможен е и директен печат от самата форма на фактурата, чрез панела **Печат на фискален принтер**.

Когато системата намери допустими плащания, в панела се показва името и номера на плащането, което ще бъде използвано за печат, заедно с начина на плащане и сумата.

За допустими се считат плащания, които:

- са свързани с текущата фактура;
- не са анулирани;
- са в статус **Планиран** или по-висок;
- са в базовата валута на собствената фирмата;
- не са вече отпечатани на фискално устройство.

Ако има повече от едно допустимо плащане, с бутон **Следващ** може да се преминава към следващото. Плащанията се показват във възходящ ред по **Номер на вноска**, а след това по **Дата на изискуемост** на родителското Платежно искане.

След успешен печат - отпечатаното плащане преминава в статус **Завършен**, формата на фактурата се опреснява и ако има следващо допустимо плащане, то се показва в панела.
