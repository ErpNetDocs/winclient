...
Когато системата намери допустими плащания, в панела се показва името и номера на плащането, което ще бъде използвано за печат, заедно с датата на изискуемост, падежната дата, начина на плащане и сумата.

За допустими се считат плащания, които:

- са свързани с текущата фактура;
- не са анулирани;
- са в статус **Планиран**, **Потвърден** или **Пуснат**;
- са в базовата валута на собствената фирмата;
- не са вече отпечатани на фискално устройство.

Ако има повече от едно допустимо плащане, с бутон **Следващ** може да се преминава към следващото.
